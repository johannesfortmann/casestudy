...
component_K4 <- component_K4 %>%
  ...
  mutate(component_K4_failure = as.factor(component_K4_failure)) 
...
component_K3AG1 <- component_K3AG1 %>%
  ...
  mutate(component_K3AG1_failure = as.factor(component_K3AG1_failure)) 
...
component_K3SG1 <- component_K3SG1 %>%
  mutate(id_gearshift = as.factor(id_gearshift)) %>%
  mutate(component_K3SG1_failure = as.factor(component_K3SG1_failure)) 
...
component_K2LE1 <- component_K2LE1 %>%
  ...
  mutate(component_K2LE1_failure = as.factor(component_K2LE1_failure)) 
...
component_K2ST1 <- component_K2ST1 %>%
  mutate(id_seats = as.factor(id_seats)) %>%
  mutate(component_K2ST1_failure = as.factor(component_K2ST1_failure)) 
...
component_K1BE1 <- component_K1BE1 %>%
  ...
  mutate(component_K1BE1_failure = as.factor(component_K1BE1_failure)) 
...
component_K1DI1 <- component_K1DI1 %>%
  mutate(id_engine = as.factor(id_engine)) %>%
  mutate(component_K1DI1_failure = as.factor(component_K1DI1_failure)) 
...
component_K5 <- component_K5 %>%
  mutate(id_body = as.factor(id_body)) %>%
  mutate(component_K5_failure = as.factor(component_K5_failure)) 
...
part_T01 <- part_T01 %>% 
  ...
  mutate(part_T01_failure = as.factor(part_T01_failure))
...
part_T02 <- part_T02 %>% 
  ...
  mutate(part_T02_failure = as.factor(part_T02_failure))
...
part_T03 <- part_T03 %>% 
  ...
  mutate(part_T03_failure = as.factor(part_T03_failure))
...
part_T04 <- part_T04 %>% 
  ...
  mutate(part_T04_failure = as.factor(part_T04_failure))
...
part_T05 <- part_T05 %>% 
  ...
  mutate(part_T05_failure = as.factor(part_T05_failure))
...
part_T11 <- part_T11 %>% 
  mutate(id_T11 = as.factor(id_T11)) %>% 
  mutate(part_T11_failure = as.factor(part_T11_failure))
...
part_T12 <- part_T12 %>% 
  mutate(id_T12 = as.factor(id_T12)) %>% 
  mutate(part_T12_failure = as.factor(part_T12_failure))
...
part_T13 <- part_T13 %>% 
  mutate(id_T13 = as.factor(id_T13)) %>% 
  mutate(part_T13_failure = as.factor(part_T13_failure))
...
part_T14 <- part_T14 %>% 
  mutate(id_T14 = as.factor(id_T14)) %>% 
  mutate(part_T14_failure = as.factor(part_T14_failure))
...
part_T15 <- part_T15 %>% 
  mutate(id_T15 = as.factor(id_T15)) %>% 
  mutate(part_T15_failure = as.factor(part_T15_failure))
...
part_T21 <- part_T21 %>% 
  mutate(id_T21 = as.factor(id_T21)) %>% 
  mutate(part_T21_failure = as.factor(part_T21_failure))
...
part_T22 <- part_T22 %>% 
  mutate(id_T22 = as.factor(id_T22)) %>% 
  mutate(part_T22_failure = as.factor(part_T22_failure))
...
part_T23 <- part_T23 %>% 
  mutate(id_T23 = as.factor(id_T23)) %>% 
  mutate(part_T23_failure = as.factor(part_T23_failure))
...
part_T24 <- part_T24 %>% 
  mutate(id_T24 = as.factor(id_T24)) %>% 
  mutate(part_T24_failure = as.factor(part_T24_failure))
...
part_T25 <- part_T25 %>% 
  mutate(id_T25 = as.factor(id_T25)) %>% 
  mutate(part_T25_failure = as.factor(part_T25_failure))
...
part_T30 <- part_T30 %>% 
  mutate(id_T30 = as.factor(id_T30)) %>% 
  mutate(part_T30_failure = as.factor(part_T30_failure))
...
part_T31 <- part_T31 %>% 
  mutate(id_T31 = as.factor(id_T31)) %>% 
  mutate(part_T31_failure = as.factor(part_T31_failure))
...
part_T32 <- part_T32 %>% 
  mutate(id_T32 = as.factor(id_T32)) %>% 
  mutate(part_T32_failure = as.factor(part_T32_failure))
...
part_T33 <- part_T33 %>% 
  mutate(id_T33 = as.factor(id_T33)) %>% 
  mutate(part_T33_failure = as.factor(part_T33_failure))
...
data2 <- data %>%
  left_join(parts_in_component_K1BE1, by = c("id_body" = "id_K1BE1")) %>%
